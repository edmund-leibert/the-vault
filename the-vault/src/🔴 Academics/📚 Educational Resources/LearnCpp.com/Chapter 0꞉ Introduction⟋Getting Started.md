...
How do I get the most out of these tutorials? #anki-card-reverse 
...
What is a **computer program** (also commonly called an **application**)? #anki-card-reverse 
A set of instructions that the computer can perform in order to perform some task.
^1682810812689


What is the process of creating a program called? #anki-card-reverse 
It is called **programming**.
^1682810812692


What do programmers typically produce? #anki-card-reverse 
source code (commonly shortened to **code**)
^1682810812695


What is source code? #anki-card-reverse 
(Commonly shorted to **code**), is a list of commands typed into one or more text files.
^1682810812699


What is the collection of physical computer parts that make up a computer and execute programs called? #anki-card-reverse 
**hardware**
^1682810812703


What is **running** or **executing** the program? #anki-card-reverse 
...
What is the limited set of instructions that a CPU can understand directly called? #anki-card-reverse 
**machine code** (or **machine language** or an **instruction set**).
^1682810812710


In regard to instructions, what is each individual 0 or 1 called? #anki-card-reverse 
A **binary digit**, or **bit** for short.
^1682810812714


For instructions, can the number of bits vary? #anki-card 
...
Why was assembly language invented? #anki-card-reverse 
Because machine language is so hard for humans to read and understand.
^1682810812720


Can the CPU understand assembly language directly? #anki-card 
No.
^1682810812724


What must be done before an assembly program can be executed by the computer? #anki-card-reverse 
It must be translated into machine language.
^1682810812727


What translates an assembly program into machine language? #anki-card-reverse 
A program called an **assembler**.
^1682810812730


Is the assembly language portable? #anki-card 
...
What is a key feature of high level languages? #anki-card-reverse 
...
What is a **compiler**? #anki-card-reverse 
A program that reads source code and produces a stand-alone executable program that can be run.
^1682810812740


Once your code has been turned into an executable, do you need a compiler to run the program? #anki-card 
No, you do not.
^1682810812743


What is an executable? #anki-card-reverse 
...
Do executable files just contain machine code? #anki-card 
...
How should one visualize a simplified representation of the compiling process? #anki-card-reverse 
![[the-vault/assets/images/learncpp-com-compiling-min.webp|450]]
^1682810812753


What is an **interpreter**? #anki-card 
...
What do interpreters tend to be? #anki-card-reverse 
...
How should one visualize the interpretation process? #anki-card-reverse  
![[the-vault/assets/images/learncpp-com-interpreting-min.webp|450]]
^1682810812763


What is the difference between compiled and interpreted languages? #anki-card 
...
What are the general exceptions to portability? #anki-card-reverse 
...
Q: What are some disadvantages of using C++ over other languages? #anki-card
...
Does C++ have manual memory management? #anki-card 
Yes.
^1683681336554

What is the definition of semantics? #anki-card-reverse 
...
What is the definition of syntax? #anki-card-reverse 
...
What is an example of semantics vs syntax? #anki-card 
...
What is the difference between semantics and pragmatics? #anki-card-reverse 
...
What is an example of semantics vs pragmatics? #anki-card 
...
What is C++ best thought of as? #anki-card 
A superset of C, though this is not strictly true (as C99 introduced a few features that do not exist in C++).
^1682810812790


What is C++ primary claim to fame? #anki-card-reverse 
It is an object-oriented language.
^1682810812793


What is a **language standard** (or **language specification**)? #anki-card-reverse 
...
What is the underlying design philosophy of C? #anki-card 
“trust the programmer”
^1682810812800


Question: What is C++? #anki-card-reverse 
...
Question: What is a compiler? #anki-card-reverse 
...
Question: What is the difference between a compiler and an interpreter? #anki-card-reverse 
...
Question: What is object-oriented programming? #anki-card-reverse 
...
Question: What are the benefits of using C++? #anki-card-reverse 
...
Question: What is a header file? #anki-card-reverse 
...
Question: What is a namespace? #anki-card-reverse
...
Question: What is a class? #anki-card-reverse 
...
Question: What is an object? #anki-card-reverse 
...
Question: What is inheritance in C++? #anki-card-reverse 
...
How should one visualize a simplistic approach to C++? #anki-card-reverse  
![[the-vault/assets/images/learncpp-com-development-min.webp|300]]
^1682810812832


What are the general steps to how C++ programs get developed? #anki-card-reverse 
...
What is the issue of immediately coding a solution? #anki-card-reverse 
...
Typically, good solutions have what characteristics? #anki-card-reverse 
...
What is **debugging**? #anki-card-reverse 
Removing bugs.
^1682810812844


Where does the term *bug* come from? #anki-card 
...
Studies have shown what about how much of a programmer’s time is actually spent writing the initial program? #anki-card 
20%. The other 80% is spent on maintenance.
What does maintenance usually consist of for a programmer? #anki-card-reverse 
- **debugging**
...
What typical features does a editor have? #anki-card-reverse 
- Line numbering
...
What is needed to compile C++ programs? #anki-card-reverse 
A C++ compiler.
^1682810812856


What does the C++ compiler do? How many tasks are there for it? #anki-card-reverse 
...
What are object files typically named? #anki-card-reverse 
*named.o* or *name.obj*, where name is the same name as the .cpp file it was produced from.
^1682810812862


If my program had 3 .cpp files, how many object files would I generate? #anki-card 
...
What happens after a compiler creates one or more object files? #anki-card 
Another program called the **linker** kicks in.
^1682810812869


What is the job of the linker? How many tasks does the linker do? #anki-card-reverse 
...
How should one visualize a linker? #anki-card-reverse 
...
What is an **Integrated Development Environment (IDE)**? #anki-card-reverse 
...
**What is an IDE?**
**Question**: What does IDE stand for in the context of programming? #anki-card-reverse 
**Answer**: IDE stands for Integrated Development Environment.
^1682810812884


**Why use an IDE for C++ programming?**
**Question**: What are some benefits of using an IDE for C++ programming? #anki-card-reverse
...
**Question**: Can you name a few popular IDEs for C++ programming? #anki-card-reverse
...
**Question**: What steps do I need to follow to install an IDE for C++ programming? #anki-card-reverse
...
**Question**: What steps do I need to follow to set up an IDE for C++ development? #anki-card-reverse
...
**What is a compiler?**
**Question**: What is a compiler and what does it do in C++ programming? #anki-card-reverse
...
**What is a debugger?**
**Question**: What is a debugger and how can it help in C++ programming? #anki-card-reverse
...
**What is a linker?**
**Question**: What is a linker and what does it do in C++ programming? #anki-card-reverse 
...
What is a **console project**? #anki-card-reverse 
A program that can be run from the Windows, Linux, or Mac console.
^1682810812920


By default, do console applications have no graphical user interface (GUI)? #anki-card 
Yes, this is true.
^1682810812923
...
What is a **workspace**? #anki-card-reverse 
...
Should I add multiple projects to a single solution? #anki-card
...
What is traditionally the first program programmers write in a new language? #anki-card-reverse 
...
When creating a project in Visual Studio, what is important to remember when setting up? Think about the solution and project location… #anki-card 
...
What are precompiled headers? #anki-card 
...
How is an executable produced? #anki-card-reverse 
...
What is **rebuild**? #anki-card-reverse 
Does a “clean”, followed by a “build”.
^1682810812954


What is **compile**? #anki-card-reverse 
...
What is **run/start**? #anki-card-reverse 
...
What do if when executing a program, the console window blinks and then closes immediately. #anki-card 
...
What libraries allows using precompiled headers in Visual Studio? #anki-card 
- `#include "stdafx.h"` ← Older library
- `#include "pch.h"` ← Best to use this library
^1682810812967


When I compile my program, I get a warning about “Cannot find or open the PDB file” #anki-card 
...
What is a **build configuration** (also called a **build target**)? #anki-card-reverse 
- A collection of project settings that determines how your IDE will build our project.
^1682810812973


What does a build configuration typically include? #anki-card-reverse 
...
How many build configurations do most IDEs set up? #anki-card-reverse 
...
What is the **debug configuration**? #anki-card-reverse 
...
What is the **release configuration**? #anki-card-reverse 
...
For GCC/G++ users, how do you set the GNU C++ compiler? #anki-card 
...
What defines the rules about how programs should behave in specific circumstances? #anki-card-reverse 
programming language standards
^1682810812996


What are **compiler extensions**? #anki-card-reverse 
...
What is the best practice regarding **compiler extensions**? #anki-card 
> [!tip]+ Best practice
...
For GCC/G++ users, how do you set the GNU C++ compiler to disable compiler extensions? #anki-card-reverse  
Add the `-pedantic-errors` flag to the compile command line
^1682810813007

What is important to remember regarding compiler extension settings? #anki-card 
> [!info]
> A reminder
...
Is there a way to explicitly tell the compiler to not generate a particular warning for the line of code in question? #anki-card 
...
How do most compilers generally generate warnings? #anki-card 
Only generate warnings about the most obvious issues.
^1682810813014


What is the best practice regarding setting the compiler’s warning levels? #anki-card 
> [!tip]+ Best practice
> Turn your warning levels up to the maximum, especially while you are learning. It will help you identify possible issues.
^1682810813017


For GCC/G++ users, how do you set the GNU C++ compiler to increase warning levels up to the maximum? #anki-card-reverse 
...
What should you tell your compiler in regards to how it should handle warnings? #anki-card-reverse 
> [!tip]+ Best practice
> Enable “Treat warnings as errors”. This will force you to resolve all issues causing warnings.
^1682810813024


For GCC/G++ users, how do you set the GNU C++ compiler to treat warnings as errors? #anki-card 
...
How are finalized C++ language standards named? #anki-card
...
How do professional environments choose a language standard? #anki-card 
...
How do you tell the GNU C++ compiler to use a specific C++ standard? #anki-card-reverse 
