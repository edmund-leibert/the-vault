...
What is a **statement**? #anki-card-reverse 
A type of instruction that causes the program to *perform some action*.
^1682908022587

What is the smallest independent unit of computation in the C++ language? #anki-card 
A statement.
^1682908022608

What do most statements in C++ end with? #anki-card 
a semicolon
^1682908022616

If I see a line that ends in a semicolon, it’s probably a… #anki-card 
statement
^1682908022624

What is a trait of high level languages (e.g. C++) in regard to statements? #anki-card 
A single statement may compile into many machine language instructions
^1682908022632

What are the different kinds of statements in C++? #anki-card 
...
What are selection statements also known as? #anki-card-reverse 
conditionals
^1682908022646

What are iteration statements also known as? #anki-card-reverse 
loops
^1682908022653
...
What are statements typically grouped into? #anki-card 
functions
^1682908022660

What are **functions** in C++? #anki-card-reverse 
A collection of statements that get executed sequentially (in order, from top to bottom)
^1682908022667

What is the significance of the special function named **main**? #anki-card 
> [!tip]+ Rule
...
What is a **function**? #anki-card 
A collection of statements that get executed sequentially (in order, from top to bottom)
^1682908022695

What must every C++ program have? #anki-card 
> [!tip]
...
What does returning a value of 0 to the operating system mean? #anki-card 
...
What is a **syntax**? #anki-card-reverse 
The rules that govern how sentences are constructed in a language.
^1682908022726


What is a syntax error?  #anki-card-reverse 
...
What type of error is a syntax error? When does it occur? #anki-card-reverse 
...
Question #3 
What is the name of the function that all programs must have? #anki-card 
main
^1682908022760

Question #4
When a program is run, where does execution start? #anki-card 
Execution starts with the first statement inside the _main_ function.
^1682908022767

Question #5
What symbol are statements in C++ often ended with? #anki-card 
The semicolon (`;`)
^1682908022777

Question #6
What is a syntax error? #anki-card 
...
Question #7
What is the C++ Standard Library? #anki-card 
...
What is a **comment**? #anki-card-reverse 
...
What does `//` symbol mean in C++? #anki-card-reverse 
...
What are **snippets** of code? #anki-card-reverse 
...
What does the symbols `/*` and `*/` mean in C++? #anki-card-reverse 
- Denotes a C-style multi-line comment
- Everything in between the symbols is ignored
^1682908022820

Should you use multi-line comments inside other multi-line comments? #anki-card 
> [!warning]
...
When should comments typically be used? #anki-card 
...
What is the best practice regarding comments? #anki-card 
> [!tip]
...
If you need to comment out a code block that contains multi-line comments, you can also consider… #anki-card 
...
- At the statement level, use comments to describe… #anki-card 
- *what*
- *how*
- *why*
^1682908022882
...
How do programs actually produce results? #anki-card 
They do so by manipulating (reading, changing, and writing) data.
^1682908022888


What is **data** in computing? #anki-card-reverse  
Any information that can be moved, processed, or stored by a computer.
^1682908022895


Data on a computer is typically stored in a format that is efficient for storage or processing. What is this more efficient format? #anki-card-reverse 
binary.
^1682908022902
...
What does **RAM** stand for? #anki-card 
random access memory
^1682908022909

What does the the word “random” mean in RAM? #anki-card 
...
In general programming, what does the term *object* refer to? #anki-card 
...
How do we create a variable? #anki-card 
...
Is a **definition** a type of declaration statement? #anki-card 
Yes
^1682908023045

When is a variable instantiated? #anki-card 
When the program is run (called **runtime**)
^1682908023060


What is **instantiation**? #anki-card 
...
What is an instantiated object sometimes called? #anki-card-reverse 
**instance**.
^1682908023082
...
What is a **data type**? #anki-card-reverse 
...
In C++, must the type of variable be known at **compile-time**? #anki-card 
Yes.
^1682908023103

Can a variable change type during compile time? #anki-card 
No.
^1682908023112

Does C++ allow you to create user-defined types? #anki-card 
Yes.
^1682908023118
...
Is it possible to define multiple variables *of the same type* in a single statement in C++? #anki-card 
Yes.
For example:
```cpp
int a;
...
What is best practice regarding defining multiple variables #anki-card 
> [!tip] Best practice
...
In C++, what do we use variables for? #anki-card 
To access memory
^1682908023133

What do variables have? #anki-card-reverse 
- an identifier
- a type
- a value
^1682908023140
...
What is **copy assignment**? #anki-card 
...
What is one downside of assignment? #anki-card 
...
What is **initialization**? #anki-card-reverse  
When a variable is defined, and you also provide an initial value for the variable at the same time.
^1682908023230


What is the **initializer**? #anki-card-reverse 
The value used to initialize a variable.
^1682908023238


What are the basic ways to initialize variables in C++? #anki-card-reverse 
```cpp
...
What is another name for direct list initialization? #anki-card 
...
What is **default initialization**? #anki-card-reverse 
...
What is **copy initialization**? #anki-card-reverse 
...
When is copy initialization used? #anki-card 
...
What is **direct initialization**? #anki-card-reverse 
...
Why was direct initialization introduced? #anki-card-reverse  
...
When is direct initialization also used? #anki-card 
When values are explicitly cast to another type.
^1682908023295


What is one of the reasons direct initialization has fallen out of favor? #anki-card 
...
What is **list initialization**? #anki-card 
...
Why was list initialization provided to C++ developers? #anki-card 
...
What additional benefit does list initialization have? #anki-card 
...
What happens when you try to assign a number (4.5) to an integer variable via copy *or* direct initialization? #anki-card 
...
What is the best practice regarding list initializations? #anki-card 
> [!tip] Best practice
...
What is **value initialization**? #anki-card-reverse 
...
When should I do an explicit initialization vs a value initialization? #anki-card
...
What is the best practice regarding initializing variables? #anki-card 
...
Can you initialize multiple variables defined on the same line? #anki-card 
```cpp
...
What is the [[maybe_unused]] attribute? #anki-card 
...
**Question #1**
What is the difference between initialization and assignment? #anki-card 
Initialization gives a variable an initial value at the point when it is created. Assignment gives a variable a value at some point after the variable is created.
^1682908023396


**Question #2**
What form of initialization should you prefer when you want to initialize a variable with a specific value? #anki-card 
Direct list initialization (aka. direct brace initialization).
^1682908023403


**Question #3**
What are default initialization and value initialization? What is the behavior of each? Which should you prefer? #anki-card 
...
What does the *io* part of *iostream* stand for? #anki-card 
*input/output*
^1682908023416
...
When often are buffered systems used? #anki-card 
- Cases where processing a few large batches of data is more efficient than processing smaller batches
^1682908023422


Buffering maximizes what at the cost of what? #anki-card 
Buffering maximizes overall throughput, at the cost of increasing response time.
^1682908023428


If your program crashes, aborts, or is paused (e.g. for debugging purposes) before the buffer is flushed, what happens to the output? #anki-card 
...
Do we need to use '\n' when getting input from the user via the console? #anki-card 
...
Is it possible to input more than one value on a single line? #anki-card 
...
Does the C++ I/O library provide a way to accept a keyboard input without the user having to press *enter* #anki-card
...
How can you prevent reading a fail state from occurring? #anki-card 
...
**Front of Card**: What does `std::cout` stand for? #anki-card 
...
**Front of Card**: How do we include the iostream header in our code? #anki-card 
...
**Front of Card**: What is the insertion operator and what is it used for? #anki-card 
...
**Front of Card**: How can we print the value of a variable using `std::cout`? #anki-card 
...
**Front of Card**: How can we print more than one thing on the same line using `std::cout`? #anki-card 
...
**Front of Card**: What does `std::endl` do and when should we use it? #anki-card 
...
**Front of Card**: What is the buffer in C++ and how does it relate to `std::cout`? #anki-card 
...
Is output typically sent to the console immediately? #anki-card 
No, it is typically added to the buffer.
^1684649100270


**Front of Card**: What is the preferred way to move the cursor to the next line of the console when outputting text? #anki-card 
...
**Front of Card**: What is `std::cin` and what is it used for? #anki-card 
...
**Front of Card**: How do we get input from the user using `std::cin`? #anki-card 
...
**Front of Card**: How can we prompt the user for input when using `std::cin`? #anki-card 
...
Does C/C++ initialize most variables to a given value? #anki-card 
No, the variable is given what ever (garbage) value is at the memory address it is given.
^1682990891639

What is an **uninitialized variable** called? #anki-card 
...
What is the point of this lack of initialization feature in C/C++? #anki-card 
...
What is undefined behavior (often abbreviated **UB**)? #anki-card
...
What is **Implementation-defined behavior**? #anki-card 
...
What is the best practice regarding implementation-defined and unspecified behavior? #anki-card 
> [!tip]+ Best practice
...
**Question #1**
What is an uninitialized variable? Why should you avoid using them? #anki-card 
An uninitialized variable is a variable that has not been given a value by the program (generally through initialization or assignment). Using the value stored in an uninitialized variable will result in undefined behavior.
^1682990891674


**Question #2**
What is undefined behavior, and what can happen if you do something that exhibits undefined behavior? #anki-card 
...
What are **keywords** in C++? #anki-card 
...
What are special identifiers in C++? #anki-card 
...
What are the rules that must be followed when naming identifiers? #anki-card 
...
What is the convention for naming C++ variables? #anki-card 
...
What is the convention for naming functions? #anki-card 
...
What is the convention for naming user-defined types? #anki-card 
...
If the variable or function name is multi-word, there are two common conventions: words separated by underscores, called snake_case, or intercapped (sometimes called camelCase, since the capital letters stick up like the humps on a camel). #anki-card 
```cpp
...
What if I am working someone else’s code? Then what convention should I use? #anki-card 
...
Should you have your identifiers start with an underscore? #anki-card 
...
What is a good rule of thumb for naming? #anki-card 
...
**Q:** What is the keyword `alignas` used for in C++? #anki-card
...
What can the `alignas` specifier may be applied to what? #anki-card 
...
What is the difference between `alignof` and `sizeof` in C++? #anki-card 
...
What does is the equivalent operator for `and_eq`? #anki-card-reverse  
The equivalent operator is `&=`
^1684425782871

**Q:** What is the keyword `asm` used for in C++? #anki-card
**A:** <span class="spoiler">`asm`</span> is used to insert assembly language instructions directly into C++ code.
^1682992534839


**Q:** What is the keyword `auto` used for in C++? #anki-card
...
**Q:** What is the keyword `bitand` used for in C++? #anki-card
**A:** <span class="spoiler">`bitand`</span> is a bitwise AND operator.
^1682992534850


**Q:** What is the keyword `bitor` used for in C++? #anki-card
...
**Q:** What is the keyword `compl` used for in C++? #anki-card
...
What is a benefit to using `constexpr`? #anki-card 
Can help improve performance since computation is done at compile-time rather than at run-time.
^1684424952051

What are some restrictions for `constexpr`? #anki-card 
...
**Q:** How does `constinit` (since C++) work? #anki-card 
...
What is best practice regarding line length? #anki-card 
> [!tip]+ Best practice
> Consider keeping your lines to 80 chars or less in length.
^1684853063188

What should one do if a long line is split with an operator (e.g. << or +)? #anki-card 
```cpp
std::cout << 3 + 4
    + 5 + 6
    * 7 * 8;
...
What approach should you use for formatting? #anki-card 
> [!tip]+ Best practice
...
What should we append to the operator’s symbol? #anki-card 
> [!note] Author’s note
...
How many arities does operators in C++ have? #anki-card 
...
Do some operators have more than one meaning depending on how they are used? #anki-card 
...
How do arithmetic operators execute? #anki-card 
...
How should one visualize how operators return values? #anki-card 
...
Are expression only those combinations that are used to calculate a values? #anki-card 
...
What is the difference between a statement and an expression? #anki-card 
...
How should we tackle this? #anki-card 
In steps.
> [!tip]+ Best practice
...
When does undefined behavior occur? What are the consequences of undefined behavior? #anki-card 
